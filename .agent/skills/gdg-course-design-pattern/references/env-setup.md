...
This document defines the standard local setup for developing and running Local Agent OS.
...
- `GET /health` should return healthy status (if endpoint is implemented).
